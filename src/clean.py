...
def state_clean(df):
    ...
    states = dict(us_states.items() | ca_states.items())
...
def remove_useless_columns(df):
    # Drop columns "ORIGIN_COUNTRY", "ORIGIN_CITY", "ORIGIN_STATE", "ORIGIN_ZIP", "DEST_COUNTRY", "DEST_CITY", "DEST_STATE", "DEST_ZIP", "ACTUAL_EQUIP", "LINEHAUL_COSTS", "FUEL_COSTS", "ACC._COSTS", "Insert_Date", "DURATION"
    df = df.drop(columns=["ORIGIN_COUNTRY", "ORIGIN_CITY", "ORIGIN_STATE", "ORIGIN_ZIP", "DEST_COUNTRY", "DEST_CITY",
                          "DEST_STATE", "DEST_ZIP", "ACTUAL_EQUIP", "LINEHAUL_COSTS", "FUEL_COSTS", "ACC._COSTS",
                          "Insert_Date", "DURATION"])
